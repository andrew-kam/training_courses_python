...
if __name__ == "__main__":
    ...
    # pytest -v -rsxX -m "smoke and not beta_users" stepik_auto_testing/part_3/3_5_7_task_mark_test.py

# https://stepik.org/lesson/236918/step/7?auth=login&next=&unit=209305
